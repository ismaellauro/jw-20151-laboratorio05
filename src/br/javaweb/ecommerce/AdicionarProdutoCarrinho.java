...
public class AdicionarProdutoCarrinho extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.println("<h4> Codigo do produto recebido: </h4>" + produto + "<br>");
        out.println("<h3><b><a href='catalogoProdutos'>Continuar Comprando</a></h3></b>");
        out.println("<h3><b><a href='index.html'>Home</a></h3></b>");
